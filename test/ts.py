...
#from model.mobilenetv3 import MobileNetV3_Small as Net
...
def draw(acc,auc,f1,loss,f_acc,f_auc,f_f1):
    ...
    plt.savefig('./result/best_'+NAME+'.png')
    plt.show()
...
#------------------------------------------------------------------------------------------------------------------------
    ...
    torch.save(net.state_dict(), 'net/best_'+NAME+'.pth')
